...
class Pawn(Piece):
    ...
    def updatemoves(self,game):
        ...
        if board.getcell(self.x+(self.color),self.y+1) and board.getcell(self.x+(self.color),self.y+1).piece!=None and board.getcell(self.x+(self.color),self.y+1).piece.color!=self.color:
            self.validmoves.add([self.x+(self.color)][self.y+1])
...
class Board:
    ...
    def reset(self):
        ...
        self.cells[0][0]=Cell(0,0,Rook("rook1",0,0,0))
        self.cells[0][1]=Cell(0,1,Knight("knight1",0,1,0))
        self.cells[0][2]=Cell(0,2,Bishop("bishop1",0,2,0))
        self.cells[0][3]=Cell(0,3,Queen("queen",0,3,0))
        self.cells[0][4]=Cell(0,4,King("king",0,4,0))
        self.cells[0][5]=Cell(0,5,Bishop("bishop2",0,5,0))
        self.cells[0][6]=Cell(0,6,Knight("knight2",0,6,0))
        self.cells[0][7]=Cell(0,7,Rook("rook2",0,7,0))
        self.cells[1][0]=Cell(1,0,Pawn("pawn1",1,0,0))
        self.cells[1][1]=Cell(1,1,Pawn("pawn2",1,1,0))
        self.cells[1][2]=Cell(1,2,Pawn("pawn3",1,2,0))
        self.cells[1][3]=Cell(1,3,Pawn("pawn4",1,3,0))
        self.cells[1][4]=Cell(1,4,Pawn("pawn5",1,4,0))
        self.cells[1][5]=Cell(1,5,Pawn("pawn6",1,5,0))
        self.cells[1][6]=Cell(1,6,Pawn("pawn7",1,6,0))
        self.cells[1][7]=Cell(1,7,Pawn("pawn8",1,7,0))
        self.cells[7][0]=Cell(7,0,Rook("rook1",7,0,1))
        self.cells[7][1]=Cell(7,1,Knight("knight1",7,1,1))
        self.cells[7][2]=Cell(7,2,Bishop("bishop1",7,2,1))
        self.cells[7][3]=Cell(7,3,Queen("queen",7,3,1))
        self.cells[7][4]=Cell(7,4,King("king",7,4,1))
        self.cells[7][5]=Cell(7,5,Bishop("bishop2",7,5,1))
        self.cells[7][6]=Cell(7,6,Knight("knight2",7,6,1))
        self.cells[7][7]=Cell(7,7,Rook("rook2",7,7,1))
        self.cells[6][0]=Cell(6,0,Pawn("pawn1",6,0,1))
        self.cells[6][1]=Cell(6,1,Pawn("pawn2",6,1,1))
        self.cells[6][2]=Cell(6,2,Pawn("pawn3",6,2,1))
        self.cells[6][3]=Cell(6,3,Pawn("pawn4",6,3,1))
        self.cells[6][4]=Cell(6,4,Pawn("pawn5",6,4,1))
        self.cells[6][5]=Cell(6,5,Pawn("pawn6",6,5,1))
        self.cells[6][6]=Cell(6,6,Pawn("pawn7",6,6,1))
        self.cells[6][7]=Cell(6,7,Pawn("pawn8",6,7,1))
